...
QTextCodec * TEDisplayVF2029::ibm866=QTextCodec::codecForName("IBM866");

/*!
 * TEDisplayVF2029 is a driver class for 20x2 PTC compatible customer displays. 
 * TEDisplayVF2029(int pn) - class constructor.
 * pn is a com port number.
 */
TEDisplayVF2029::TEDisplayVF2029(int pn): TEDisplayBase(pn),
	updInterval(100),bBrightnessPending(false),bLoadCharsPending(false),
	bInitPending(true)
{
	setName("TEDisplayVF2029");
	iInitCounter=200;
	iBrightness=255;
	m_baudRate=9600;
  setCommandSet(CS_FIRICH);
	m_ee.addProcBinding3<TEDisplayVF2029,const QString &,const QString &,const QString &>(
        this,&TEDisplayVF2029::showText,"showText");
};
 ...
 */
void 
TEDisplayVF2029::initDisplayInternal()
{
	QCString initstring;
 ...
 */
void 
TEDisplayVF2029::setDisplayMode(const QString & mode)
{
 ...
 */
void 
TEDisplayVF2029::setBrightnessInternal()
{
	char brcommand[][6]=
    {
 ...
 */
void 
TEDisplayVF2029::setUpdateInterval(int interval)
{
 ...
 */
void 
TEDisplayVF2029::setBrightness(int iBr)
{
	if (iBr<0 || iBr>255)
		return;
	iBrightness=iBr;
 ...
 */
void 
TEDisplayVF2029::showText(const QString & text, const QString & category, 
		const QString & mode)
{
	SEffect eff;
 ...
 */
void 
TEDisplayVF2029::processEvent( int /*Code*/ )
{
};
 ...
 */
void 
TEDisplayVF2029::loadUserDefChars(int _firstChar, int _lastChar, const QByteArray & arr)
{
 ...
 */
void 
TEDisplayVF2029::loadUserDefCharsInternal()
{
 ...
 */
QCString 
TEDisplayVF2029::utf8ToDevice( const QString &text )
{
  QTextCodec *codec = QTextCodec::codecForName("IBM866");
  char hardsign=(char)0xea;
  char softsign=(char)0xec;
  char Hardsign=(char)0x9a;
  char Softsign=(char)0x9c;

  // Default codepage for VF2029 has swapped soft and hard signs.
  QCString text1=codec->fromUnicode( text );
  for(uint i=0;i<text1.length();i++)
    if (text1.at(i)==hardsign)
      text1.at(i)=softsign;
    else if (text1.at(i)==Hardsign)
      text1.at(i)=Softsign;
    else if (text1.at(i)==softsign)
      text1.at(i)=hardsign;
    else if (text1.at(i)==Softsign)
      text1.at(i)=Hardsign;
  return text1;
 ...
 */
QString 
TEDisplayVF2029::deviceToUtf8( const QCString &text )
{
  char hardsign=(char)0xea;
  char softsign=(char)0xec;
  char Hardsign=(char)0x9a;
...
int 
TEDisplayVF2029::scrollSpeed()
{
	return 1000/updInterval;
}

void 
TEDisplayVF2029::setScrollSpeed(int speed)
{
...
void 
TEDisplayVF2029::setPortBaudRate(int iRate)
{
...
*/
int TEDisplayVF2029::setCommandSet(int eCS)
{
  switch(eCS)
  {
...
bool TEDisplayVF2029::isCommandSetSupported(int eCS)
{
  switch(eCS)
  {
    case TEDisplayBase::CS_AEDEX:
...
#include "teplugin.h"
typedef TEPlugin<TEDisplayVF2029> TEDisplayVF2029Plugin;
TE_EXPORT_PLUGIN( TEDisplayVF2029Plugin )
