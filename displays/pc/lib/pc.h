...
#ifdef PCLIB_BUILD
#  define PCLIB_EXPORT LIB_DLLEXPORT
#  define PCLIB_TEMPLATE_EXTERN
#else
#  define PCLIB_EXPORT LIB_DLLIMPORT
#  define PCLIB_TEMPLATE_EXTERN TEMPLATE_EXTERN
#endif

class PCLIB_EXPORT TEDisplayPC : public TEDisplayBase
{
	Q_OBJECT
